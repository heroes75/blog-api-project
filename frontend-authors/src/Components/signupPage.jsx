  ...
  function handleSubmit(e) {
    ...
    if (username === "") {
      ...
      setErrorMessages((prevState) =>
        prevState.concat("Please enter an username"),
      );
    } else {
    ...
    if (password === "") {
      ...
      setErrorMessages((prevState) =>
        prevState.concat("Please enter a password"),
      );
    ...
    if (confirmPassword === "") {
      ...
      setErrorMessages((prevState) =>
        prevState.concat("Please confirm your password"),
      );
    } else if (confirmPassword !== password) {
      const msg =
        "The confirmation of your password must be equal to your password";
        ...
        >
          <ul className={styles.ul}>
            {errorMessages.map((message) => (
              <li aria-label={message} key={message}>
                {message}
              </li>
            ))}
          </ul>
