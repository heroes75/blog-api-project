        ...
        <>
            ...
            <main className={styles.main}>
                <form className={styles.form} role="form" method="POST">
                    ...
                    <input className={styles.input} value={username} onChange={handleUsername} type="text" name="username" id="username" placeholder="Enter your username" />
                    <label className={styles.label} htmlFor="password">Enter your password:</label>
                    <input className={styles.input} value={password} onChange={handlePassword} type="password" name="password" id="password" placeholder="Enter your password" />
                    <label className={styles.label} htmlFor="confirmPassword">Confirm your password:</label>
                    <input className={styles.input} value={confirmPassword} onChange={handleConfirmPassword} type="password" name="confirmPassword" id="confirmPassword" placeholder="Confirm your password" />
